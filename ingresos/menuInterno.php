...
<div id="menu">
        <ul class="menu">
            ...
            <li><a href="entradas.php"><img src="../img/iconta/ingresos icon.png">Ingresos</a>
                <ul class="submenu">
                    <li><a href="facturas.php">Facturas</a></li>
                    <li><a href="crearFactura.php">Nueva Factura</a></li>
                    <li><a href="facturas.php">Facturas recurrentes</a></li>
                    <li><a href="crearFactura.php">Pagos recibidos</a></li>
                    <li><a href="facturas.php">Notas de credito</a></li>
                    <li><a href="crearFactura.php">Cotizaciones</a></li>
                    <li><a href="facturas.php">Remisiones</a></li>
                    <li><a href="crearFactura.php">POS</a></li>
           ...
           <li><a href="inventario.php"><img src="../img/iconta/inventario icon.png">Inventario</a>
                <ul class="submenu">
           ...
           <li><a href="perfil.php"><img src="../img/iconta/categorias icon.png">Categorias</a>
                <ul class="submenu">
                    <li><a href="nueva_cotizacion.php">Categorias</a></li>
                    <li><a href="productos.php">Ajustes de Categorias</a></li>
                                        
                </ul>
            </li>
            <li><a href="perfil.php"><img id="irepor" src="../img/iconta/reportes icon.png">Reportes</a>
               <ul class="submenu">
                    <li><a href="mis_cotizaciones.php">Ventas</a></li>
           ...
           <li><a href="perfil.php"><img src="../img/iconta/configuracion icon.png">Configuracion</a>
                ...
                <ul class="submenu">
                    ...
                    <li><a href="../config/perfil.php">usuario: <?php if (@$_SESSION['usuario']) {
                        echo $_SESSION['usuario'];
                    }
                    else{echo "no identificado";} ?></a></li>
                    <li><a href="conf_fact.php">Facturacion</a></li>
                    <li><a href="conf_coti.php">Plantillas</a></li>
                    <li><a href="../config/close.php">Impuestos</a></li>
                     <li><a href="conf_fact.php">Empresa</a></li>
